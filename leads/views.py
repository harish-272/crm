...
from .froms import LeadForm, LeadModelForm, CustomUserCreationForm, AssignAgentForm, LeadCategoryUpdateForm, CategoryModelForm
...
class CategoryListView(LoginRequiredMixin, generic.ListView):
    template_name= "leads/caregory_list.html"
